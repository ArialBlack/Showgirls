...
<body<?php print $body_attributes; ?>>
  ...
  <?php print $page_bottom; ?>
    <script>
        var require = { baseUrl : '/sites/all/themes/showgirls_ui/js' };
    </script>
    <script data-main="/sites/all/themes/showgirls_ui/js/requirejs-config.js" src="/sites/all/build/bower_components/requirejs/require.js"></script>
</body>
</html>
